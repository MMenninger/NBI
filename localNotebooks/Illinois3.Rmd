...
```{r setup}
source("S:/AdminGroups/PerformanceProgramming/RegionalTransportationPerformanceMeasures/Bridge_Analysis/NBI/R/convert2016.R")
nbi <- convert2016("S:/AdminGroups/PerformanceProgramming/RegionalTransportationPerformanceMeasures/Bridge_Analysis/NBI/Data/2016hwybronlyonefile.zip")
library(MazamaSpatialUtils)
library(sp)
library(rgdal)
library(purrr)
library(animation)
setSpatialDataDir("S:/AdminGroups/PerformanceProgramming/RegionalTransportationPerformanceMeasures/Bridge_Analysis/NBI/Data/Spatial")
...
Illinois is an interesting case for a couple of reasons. Bridges are not equally distributed throughout the country. There are a lot more bridges in the Eastern half. Fewer in the mountainous, less-developed west. Nebraska lies right in the middle of this divide, with a stark difference in the density of bridges in the eastern and western half of the state.  
