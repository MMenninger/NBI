...
points(nbi$longitude[nbi$water==1], nbi$latitude[nbi$water==1], col = "blue", cex = .1)
points(nbi$longitude[nbi$water==0], nbi$latitude[nbi$water==0], col = "red", cex = .3)
...
```{r floodBridges}
floodBridges <- subset(nbi, yearBuilt == 1935)
```
...
hist(floodBridges$ADT_029, n = 100000, main = "Traffic on Bridges Built in 1935", xlab = "Average Daily Traffic")
hist(floodBridges$ADT_029, n = 100000, xlim = c(0,500), main = "Zoomed-in Histogram of Traffic on Bridges Built in 1935", xlab = "Average Daily Traffic")
```
...
plot(subset(USCensusStates, stateCode == "IL"))
points(nbi, pch = 2, cex = nbi$ADT_029/80000)
